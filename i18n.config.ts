  ...
  messages: {
    ...
    ru: {
        ...
        "home": {
          "aboutUs": {
      "title": "О нас",
      "description": "НАЦИОНАЛЬНЫЙ ЦЕНТР ГИГИЕНЫ ТРУДА И ПРОФЕССИОНАЛЬНЫХ ЗАБОЙВАНИЙ предоставляет высококачественные гигиенические, медицинские и экологические услуги уже более 65 лет.",
      "paragraph1": "Наш центр ориентирован на улучшение условий труда и повышение профессиональной компетентности работников в различных отраслях.",
      "paragraph2": "Мы предлагаем комплексные решения, направленные на профилактику профессиональных заболеваний и обеспечение безопасности на рабочем месте.",
      "paragraph3": "Наша команда состоит из опытных специалистов, готовых предоставить профессиональную помощь и консультации."
    },
    "departments": {
      "title": "Наши Отделения",
      "subtitle": "Каждое отделение специализируется на определённых аспектах гигиены труда и профессиональной медицины.",
      "phone": "Телефон",
      "list": {
        "professionalTherapy": {
    ...
    "branches": {
      "title": "Филиалы",
      "subtitle": "Наши филиалы расположены по всему Казахстану, обеспечивая удобный доступ к нашим услугам.",
      "address": "Адрес",
      "phone": "Телефон",
    ...
    "contactInfo": {
      ...
      "subtitle": "Мы всегда готовы ответить на ваши вопросы и предоставить необходимую информацию.",
    ...
    "socialMedia": {
      ...
      "instagram": "Instagram"
        ...
        "support": {
          ...
          "subtitle": "Свяжитесь с нами или посетите наши филиалы и отделения",
          "headOffice": {
            "title": "Головной офис",
            "address": "Адрес",
            "addressValue": "г. Караганда, ул. Мустафина, д. 15",
            "registration": "Регистратура",
            "registrationPhone": "+7 (7212) 56 52 63",
            "reception": "Приемная",
            "receptionPhone": "+7 (7212) 56 53 10",
            "workingHours": "Часы работы",
          ...
          "departments": {
            ...
            "professionalTherapy": {
              "title": "Отделение профессиональной терапии",
              "leader": "Руководитель",
              "leaderName": "Должность и имя руководителя уточняются.",
